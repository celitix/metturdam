...
export default function HeroSection() {
  const heading = "Mettur Dam".split("");
  ...
  return (
    <section className="relative h-screen w-full flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute inset-0">
        <Image
          src="/assets/metturDAM.JPG"
          alt="Mettur Dam Background"
          fill
          priority
      ...
      <div className="relative z-10 text-center px-4">
        ...
        >
          Engineering Marvel on the Cauvery River
        </motion.p>
        ...
        <motion.h1
          ...
          initial="hidden"
          animate="visible"
          className="text-green-500 text-5xl lg:text-[160px] md:text-[120px] font-semibold tracking-wider flex justify-center"
        >
